      ...
      <Card className="relative overflow-hidden">
        ...
        <CardContent className="relative p-8">
          <div className="flex items-center justify-between">
            <div className="backdrop-blur-sm bg-background/30 p-4 rounded-lg border border-border/50">
              <h2 className="text-3xl font-bold mb-2 text-foreground">Welcome to SynqBox</h2>
              <p className="text-foreground/90 font-medium">Your device is running smoothly and ready for action</p>
            </div>
            <div className="text-right backdrop-blur-sm bg-background/30 p-4 rounded-lg border border-border/50">
              <Badge 
              ...
              <p className="text-sm text-foreground/90 font-medium mt-2">Uptime: {data.uptime}</p>
            </div>
          </div>
        </CardContent>
      </Card>
